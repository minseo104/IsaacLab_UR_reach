...
#change this
            ...
            if self.pick_color == "red":
                ...
                self.publish_pose(0.45, 0.15, 0.245)
                time.sleep(delay)

                self.publish_pose(0.45, 0.15, 0.225)
                time.sleep(delay+3)
                ...
                self.publish_pose(0.45, -0.3, 0.29)
                time.sleep(delay)

                self.publish_pose(0.45, -0.3, 0.27)
                time.sleep(delay+3)
                ...
                self.publish_pose(0.45, -0.08, 0.245)
                time.sleep(delay)

                self.publish_pose(0.45, -0.08, 0.225)
                time.sleep(delay+3)
