...
#change this
            ...
            # 3) Close gripper
            if self.pick_color == "blue":
                self.get_logger().info('Picking red object...')
                
                #modify
                self.publish_pose(0.7, -0.21, 0.38)
                time.sleep(delay)

                self.publish_pose(0.68, -0.18, 0.3)
                time.sleep(delay)

                self.publish_pose(0.55, -0.1, 0.32)
                time.sleep(delay)

                self.publish_pose(0.60, -0.2, 0.4)
                time.sleep(delay)

                self.publish_pose(0.57, 0.04, 0.32)
                time.sleep(delay)

                self.publish_pose(0.57, 0.12, 0.32)
                time.sleep(delay)

                self.publish_pose(0.42, 0.14, 0.27)
                time.sleep(delay)

                self.publish_pose(0.52, 0.2, 0.3)
                time.sleep(delay)

		#First object pose
                #self.publish_pose(0.56, -0.2, 0.4)
                #time.sleep(delay)
                #self.publish_pose(0.54, -0.2, 0.3)
                #time.sleep(delay)
                
        #Second position
                #self.publish_pose(0.6, 0.0, 0.4)
                #time.sleep(delay)
                #self.publish_pose(0.6, 0.0, 0.38)
                #time.sleep(delay)
        ...
        #Go to third pose                
                ...
                #time.sleep(delay)
                #self.publish_pose(0.52, 0.22, 0.32)
                #time.sleep(delay+4)
