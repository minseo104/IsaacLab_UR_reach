...
class FrankaCubeLiftEnvCfg(joint_pos_env_cfg.FrankaCubeLiftEnvCfg):
    def __post_init__(self):
        ...
        self.actions.arm_action = DifferentialInverseKinematicsActionCfg(
            ...
            body_name="hande_finger_distance_link",
...
class FrankaTeddyBearLiftEnvCfg(FrankaCubeLiftEnvCfg):
    def __post_init__(self):
        ...
        self.scene.robot.actuators["hande_finger_distance_link"].effort_limit = 50.0
        self.scene.robot.actuators["hande_finger_distance_link"].stiffness = 40.0
        self.scene.robot.actuators["hande_finger_distance_link"].damping = 10.0
