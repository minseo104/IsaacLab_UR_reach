...
gym.register(
    id="Isaac-Lift-Modified-Cube1-Franka-v0",
...
gym.register(
    id="Isaac-Lift-Modified-Cube2-Franka-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
...
gym.register(
    id="Isaac-Lift-Modified-Cube1-Franka-IK-Abs-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
...
gym.register(
    id="Isaac-Lift-Modified-Teddy-Bear-Franka-IK-Abs-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
...
gym.register(
    id="Isaac-Lift-Modified-Cube-Franka-IK-Rel-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
